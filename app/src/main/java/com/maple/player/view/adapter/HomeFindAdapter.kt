...
class HomeFindAdapter : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
...
//        return list?.size ?: 0
    ...
    inner class BannerViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun setData(position: Int) {
            val bannerViewPager:BannerViewPager<Banner,BannerPagerViewHolder> = itemView.findViewById(R.id.banner_view)
